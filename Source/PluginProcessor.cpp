...
// This is where parameters are defined (knobs, slides and switches on our plugin GUI)
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterChoice>("HightCut Slope", "HighCut Slope", stringArray, 0));
